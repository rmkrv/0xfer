package com.android.qttransfer.sender
...
import com.android.qttransfer.R
import com.android.qttransfer.hcc2d.Hcc2dDisplayView
import com.android.qttransfer.hcc2d.NativeHcc2dBridge
import com.android.qttransfer.qr.QrGenerator
import com.android.qttransfer.qr.QrDisplayView
import com.android.qttransfer.transfer.FileInfo
import com.android.qttransfer.transfer.TransferConfig
import com.android.qttransfer.transfer.TransferSender
...
class SenderActivity : AppCompatActivity() {
    ...
    private fun startQr(file: File, name: String?) {
        ...
        val sender = TransferSender(
            ...
            mediaType = if (name == "message.txt") com.android.qttransfer.transfer.DecimenContainer.textType() else "application/octet-stream"
        )
    ...
    private fun startHcc2d(file: File, name: String?, colors: Int) {
        ...
        job = lifecycleScope.launch(Dispatchers.Default) {
            val symbols = ArrayList<com.android.qttransfer.hcc2d.NativeHcc2dEncoded>(gridCount)
            repeat(gridCount) {
